/* codded by Millie
reedited by Milliemwol
use this git under copyright
dont change credit
*/

const Milliemwol= require('../events');
const config = require('../config');
const {MessageType, MessageOptions, Mimetype} = require('@adiwajshing/baileys');
const axios = require('axios');
const hrs = new Date().getHours({ timeZone: 'Asia/Kolkata' })

Milliemwol.addCommand({pattern: 'git', fromMe: false, desc: 'it send bot menu'}, (async (message, match) => {
...
Milliemwol New Acoount you Enjoy This Thanku 🥰
`}) 
