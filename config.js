...
module.exports = {
    ...
    SESSION: process.env.AMALSER_CODE === undefined ? '' : process.env.JUGGRUSER_CODE,
    ...
    PHONE: process.env.NUMBER === undefined ? '+919656813724' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ? 'JUGGRUSER' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By JUGGRUSER' : process.env.ALL_CAPTION,
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://i.imgur.com/V9EzbFp.jpg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'JUGGRUSER' : process.env.LOGO_NAME,
    CODE: process.env.C_CODE === undefined ? '91' : process.env.C_CODE,
    MENTION: process.env.TAG_REPLY === undefined ? '919656813724@s.whatsapp.net' : process.env.TAG_REPLY,
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'default' : process.env.ADD_MESSAGE,
    PLKS: process.env.THERI_LIST === undefined ? false : process.env.THERI_LIST,
    AFPLK: process.env.YT === undefined ? false : process.env.YT,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ 𝔧𝔲𝔤𝔤𝔯𝔲𝔰𝔢𝔯 ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'JUGGRUSER' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://i.imgur.com/2jyW0w0.jpg' : process.env.ALL_IMG,
    ...
    YAK: process.env.YAK === undefined ? '919656813724,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
