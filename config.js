...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By 𝗚𝗼𝘂𝗿𝗮𝘃' : process.env.ALL_CAPTION,
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://telegra.ph/file/56f641c3cf138aa7f27b2.jpg' : process.env.LG_LOGO,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ 𝗚𝗼𝘂𝗿𝗮𝘃 ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? '𝗚𝗼𝘂𝗿𝗮𝘃' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://telegra.ph/file/56f641c3cf138aa7f27b2.jpg' : process.env.ALL_IMG,
