...
*/
                        ...
                        try {
                            ...
                            if (config.NOLOG === 'off') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~_________~ JUGGRUSER ~______~*' +
                                    '\n*🌀 Subcribe this channel other wise chance to get erorr: https://www.youtube.com/channel/UC0C4MiybHKd2vB26EylS-5A*' +
                                    '\n\n*⚠️ ' + error + '*\n'
                                    , MessageType.text);
                            }
                        }
